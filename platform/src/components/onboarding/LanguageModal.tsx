            ...
            {SUPPORTED_LANGUAGES.map((lang) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-4 p-4 rounded-xl cursor-pointer transition-all duration-300 text-left border ${isSelecting
                ...
                >
                  ...
                  <div>
                    <p className={`font-body font-bold text-sm leading-tight transition-colors ${isSelecting ? 'text-white dark:text-[#25005a]' : 'text-on-surface'
                      }`}>{lang.native}</p>
                    <p className={`font-label text-[11px] mt-0.5 uppercase tracking-wide transition-colors ${isSelecting ? 'text-white/70 dark:text-[#25005a]/70' : 'text-on-surface-variant'
                      }`}>{lang.name}</p>
                  </div>
